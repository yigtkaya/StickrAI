...
class Language {
  ...
  @override
  String toString() {
    return 'Language(id: $id, name: $name, urlCode: $urlCode, locale: $locale, currency: $currency)';
  }
  ...
  @override
  int get hashCode {
    return id.hashCode ^ name.hashCode ^ urlCode.hashCode ^ locale.hashCode ^ currency.hashCode;
  }
}
